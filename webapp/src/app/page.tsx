  ...
  return (
    <main className="bg-[#FAF7F2] text-[#2D2D2D]">
      ...
      <section className="py-20 px-6 lg:px-20 bg-white relative overflow-hidden">
        ...
        <ScrollReveal className="max-w-6xl mx-auto text-center mb-14">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <ScrollReveal key={loc.name} delay={i * 0.2}>
              <div className="group relative rounded-2xl overflow-hidden h-[320px] flex items-end">
      ...
      <section className="py-20 px-6 lg:px-20 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <ScrollReveal delay={0.1} className="col-span-2 row-span-2 relative rounded-2xl overflow-hidden h-[400px] group">
            ...
            <ScrollReveal delay={0.2} className="relative rounded-2xl overflow-hidden h-[195px] group">
            ...
            <ScrollReveal delay={0.3} className="relative rounded-2xl overflow-hidden h-[195px] group">
            ...
            <ScrollReveal delay={0.4} className="relative rounded-2xl overflow-hidden h-[195px] group">
            ...
            <ScrollReveal delay={0.5} className="relative rounded-2xl overflow-hidden h-[195px] group">
      ...
      <section className="py-24 px-6 lg:px-20 bg-[#FAF7F2]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <ScrollReveal direction="left" className="relative group order-2 lg:order-1">
            <div className="absolute -inset-3 border-2 border-[#C5A47E] rounded-2xl -translate-x-4 translate-y-4 -z-10 opacity-25 group-hover:-translate-x-2 group-hover:translate-y-2 transition-transform duration-700"></div>
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
      ...
      <section className="py-24 px-6 lg:px-20 bg-white">
        <ScrollReveal className="max-w-7xl mx-auto text-center mb-14">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <ScrollReveal key={item.title} delay={i * 0.15}>
              <Link href="/meniu" className="block h-full group cursor-pointer bg-[#FAF7F2] rounded-2xl overflow-hidden hover:shadow-xl transition-shadow duration-500">
      ...
      <section className="py-20 px-6 lg:px-20 bg-[#FAF7F2]">
        <ScrollReveal className="max-w-5xl mx-auto text-center mb-14">
        ...
        <ScrollReveal delay={0.6} className="text-center mt-14">
